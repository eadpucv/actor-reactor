...
#define ID 1
#define WLAN_ADDR  "192.168.1.139"
#define PORT  1112
#define WLAN_SSID  "Reikiavik"
#define WLAN_PASS  "suspensitos"
...
void endstop_action() {
  if (endstop_activation == 0) {
    stepper.setCurrentPosition(0);
    motor_pos = 1;
    Serial.println(motor_pos);
    endstop_activation = 1;
  }
  if (motor_pos > 0 && endstop_position == 1)
    endstop_activation = 0;
  else if (motor_pos <= 0 && endstop_position == 0)
        endstop_activation = 0;
        //else endstop_activation = 1;
}
